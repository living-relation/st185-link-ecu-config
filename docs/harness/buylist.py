...
EXTRA = [  # harness hardware the .harness schema cannot attach to a connector
 ...
 ("2127 or 2104","Blue Sea Systems","PDB1 glove-box distribution block. 2127 = 250A / four 5/16\"-18; 2104 = 600A / four 3/8\"-16. Pick per plan doc 6.19 - depends whether starter current passes through it.",1,0),
 ("2719 or 2708","Blue Sea Systems","Insulating cover for PDB1. 2719 fits 2127, 2708 fits 2104. Not optional - PDB1 is inside the cabin.",1,0),
