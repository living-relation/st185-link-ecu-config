...
| 2–3 | Coolant Pressure | uint16 BE | 1 | 0 | kPa — widened to 2 bytes for headroom (1 byte capped 255 kPa / 37 psi) |
...
> **Cabin Temp removed (2026-06-28):** the optional Cabin Temp byte was dropped to fit 2-byte Coolant Pressure (frame was full at 8 bytes). RealDash can read cabin temp from switchboard **0x640** directly. To keep cabin temp instead, drop Trigger Error Count or add a new frame 0x3F2.
